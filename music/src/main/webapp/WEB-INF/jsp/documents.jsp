                                ...
                                <td>
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group mr-2" role="group">
                                            ...
                                            <form id="approveForm${document.id}" action="/updateDocumentStatus2" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn ẩn tài liệu này?');">
                                        ...
                                        <div class="btn-group mr-2" role="group">
                                            ...
                                            <form id="approveForm${document.id}" action="/updateDocumentStatus2" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn phục hồi tài liệu này?');">
                                                <input type="hidden" name="documentId" value="<%= document.getId() %>">
